...
public partial class GameContext {
    ...
    public GameEntity SetTime(float newDeltaTime, float newTimeSinceLevelLoad, long newFrameCount) {
        if (hasTime) {
        ...
        entity.AddTime(newDeltaTime, newTimeSinceLevelLoad, newFrameCount);
        return entity;
    }

    public void ReplaceTime(float newDeltaTime, float newTimeSinceLevelLoad, long newFrameCount) {
        var entity = timeEntity;
        if (entity == null) {
            entity = SetTime(newDeltaTime, newTimeSinceLevelLoad, newFrameCount);
        } else {
            entity.ReplaceTime(newDeltaTime, newTimeSinceLevelLoad, newFrameCount);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddTime(float newDeltaTime, float newTimeSinceLevelLoad, long newFrameCount) {
